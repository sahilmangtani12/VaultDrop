    ...
    return (
      ...
      >
        <p className="p-2 text-2xl font-bold">
          VaultDrop will not work with this browser
        </p>
        Web Storage API is not supported. VaultDrop needs this API to store private
        keys.
        <p>
  ...
  const cryptoError = () => {
    ...
    return (
      ...
      >
        ...
        VaultDrop needs this API to decrypt the data.
        <p>
          <a
            className="text-blue hover:underline"
  ...
  const apiError = () => {
    ...
    return (
      ...
      >
        ...
        The VaultDrop API is not available, please contact the administrator.
      </div>
    );
  }
  const opfsError = () => {
    ...
    return (
      ...
      >
        ...
        The Origin private file system API is not supported. VaultDrop needs this API to download files.
        <p>
          <a
            className="text-blue hover:underline"
